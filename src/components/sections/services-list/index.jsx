...
export const ServicesList = (props) => {
  ...
  useEffect(() => {
    ...
    motionMatchMedia.addEventListener("change", handleMediaQueryChange);
    return () => {
      motionMatchMedia.removeEventListener("change", handleMediaQueryChange);
    };
  }, []);
      ...
      <Container>
        <div className="services__wrapper stack column">
          ...
          <ul className="services__list">
            <div className="services__hover-wrapper">
              <motion.li
              ...
              >
                ...
                <div className="services__item-text stack column">
                  ...
                  <Typography className="services__item-description" tag="p">
                    We handle all aspects of your brand and digital
                    presence—from social media management to PR
                  </Typography>
                </div>
              </motion.li>
            </div>
            ...
            <div className="services__hover-wrapper">
              ...
              >
                ...
                <div className="services__item-text stack column">
                  ...
                  <Typography className="services__item-description" tag="p">
                    Cultivate your image and align with top platforms to grow
                    your audience
                  </Typography>
                </div>
              </motion.li>
            ...
            <div className="services__hover-wrapper services__item--list">
              <motion.li
